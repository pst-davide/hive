...
export default function(editor: Editor, opts: Required<PluginOptions>) {
  ...
  let tableStyleStr: string = '';
  let cellStyleStr: string = '';
  let tableStyle: Record<string, string> = opts.tableStyle || {};
  let cellStyle: Record<string, string> = opts.cellStyle || {};
  ...
  addBlock('sect25', {
    label: '4 Colonne',
    media: `<svg viewBox="0 0 23 24">
    <path fill="currentColor" d="M2 20h4V4H2v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1ZM7 20h4V4H7v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1ZM12 20h4V4h-4v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1ZM17 20h4V4h-4v16Zm-1 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1Z"/>
  </svg>`,
    content: `
    <table style="${tableStyleStr}">
      <tr>
  ...
  addBlock('button', {
    ...
    content: '<a class="button">Pulsante</a>',
  });
  ...
  addBlock('text', {
    ...
    content: {
      type: 'text',
      content: 'Inserisci qui il tuo testo',
      style: { padding: '10px' },
    },
  });
  ...
  addBlock('text-sect', {
    ...
    content: `
      <h1 class="heading">Inserisci il titolo</h1>
      <p class="paragraph">
        testo del paragrafo
      </p>
    `,
  ...
  addBlock('quote', {
    ...
    content: '<blockquote class="quote">Testo della citazione</blockquote>',
  });
          ...
          <table class="grid-item-card-body">
            <tr>
              <td class="grid-item-card-content">
                <h1 class="card-title">Titolo della Card</h1>
          ...
          <table class="list-item-content">
            <tr class="list-item-row">
              ...
              <td class="list-cell-right">
                <h1 class="card-title">Titolo della Lista</h1>
                <p class="card-text">Testo della lista</p>
              </td>
            </tr>
          </table>
        </td>
