...
export default (editor: Editor, opts: Required<PluginOptions>) => {
  ...
  const openExport: string = 'export-template';
  const openStyleManager: string = 'open-sm';
  const openTraits: string = 'open-tm';
  const openLayers: string = 'open-layers';
  const openBlocks: string = 'open-blocks';
  const activateOutline: string = 'sw-visibility';
  const activateFullscreen: string = 'fullscreen';
  const activatePreview: string = 'preview';
  const iconStyle: string = 'style="display: block; max-width: 22px"';
